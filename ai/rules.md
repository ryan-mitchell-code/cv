...
- Core UI components should support both light and dark mode using Tailwind's dark: variants
- Avoid excessive or redundant dark mode styling; prioritise readability and consistency
- New UI elements should not break existing dark mode or print behaviour
